...
class LightGCN(BasicModel):
    def __init__(self, 
        ...
        self.__init_weight()
        self.GAT_layer = SpGraphAttentionLayer(self.config['latent_dim_rec'], self.config['latent_dim_rec'] // 2)
...
# random normal init seems to be a better choice when lightGCN actually don't use any non-linear activation function
        ...
        self.f = nn.Sigmoid()
        self.Graph, self.norm_adj = self.dataset.getSparseGraph()
    ...
    def getEmbedding(self, users, pos_items, neg_items):
        all_users, all_items = self.computer(users=users, pos_items=pos_items, neg_items=neg_items)
